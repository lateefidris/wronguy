...
const navbarMainItems = [
  ...
  { ref: '/music', label: 'MUSIC' },
  { ref: '/shows', label: 'SHOWS' },
];
...
const StyledNavLink = ({
  ...
  <NavLink
    className={`${className ?? ''} ${
      isActive ? 'text-lime-300' : 'hover:text-gray-400'
    }`}
    {...linkProps}
  />
);
...
export function NavBar() {
        ...
        <div className="relative flex flex-col-reverse sm:flex-col gap-2">
          <div className="h-[180px] w-[140px] overflow-hidden sm:h-auto sm:w-auto mx-auto">
            <Image
              ...
              src="https://static.wixstatic.com/media/e64ac3_0ccfae7624f94568b612f17ba6f539c9~mv2.png"
              width={240}
              height={0}
              alt="Talisa Kidd"
            />
  ...
  <a href="https://www.facebook.com/bdsam.dadon/" target="_blank" rel="noreferrer">
    <svg
  ...
  <a href="https://www.instagram.com/ewol_samo/?hl=en" target="_blank" rel="noreferrer">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 448 512"
      className="w-5 h-5"
  ...
  <a href="https://www.youtube.com/@ewol_samo/featured" target="_blank" rel="noreferrer">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 576 512"
      className="w-5 h-5"
